...
//MARK: - IB Outlets
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "fourthScreenSegue" {
            if let fourthScreen = segue.destination as? FourthScreen {
                fourthScreen.game = game
            }
        }
}
...
//MARK:- IB Actions
    ...
    func gameOver() {
        performSegue(withIdentifier: "fourthScreenSegue", sender: self)
    }
